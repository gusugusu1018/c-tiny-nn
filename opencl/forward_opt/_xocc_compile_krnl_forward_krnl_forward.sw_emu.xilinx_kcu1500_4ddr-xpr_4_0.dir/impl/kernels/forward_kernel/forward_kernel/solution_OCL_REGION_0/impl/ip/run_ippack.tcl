...
set Library     "hls"
set IPName      "forward_kernel"
set Version     "1.0"
set DisplayName "Forward_kernel"
set Revision    "1711272025"
set Description "An IP generated by Vivado HLS"
set Device      "kintexu"
set Taxonomy    "/VIVADO_HLS_IP"

## Variables
set Top "forward_kernel"
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 src_data_1 W 0x0 "Data signal of src_data" {{0 32 src_data W 0 "Bit 31 to 0 Data signal of src_data"}}} {0x14 src_data_2 W 0x0 "Data signal of src_data" {{0 32 src_data W 0 "Bit 63 to 32 Data signal of src_data"}}} {0x1c dst_data_1 W 0x0 "Data signal of dst_data" {{0 32 dst_data W 0 "Bit 31 to 0 Data signal of dst_data"}}} {0x20 dst_data_2 W 0x0 "Data signal of dst_data" {{0 32 dst_data W 0 "Bit 63 to 32 Data signal of dst_data"}}} {0x28 w01_1 W 0x0 "Data signal of w01" {{0 32 w01 W 0 "Bit 31 to 0 Data signal of w01"}}} {0x2c w01_2 W 0x0 "Data signal of w01" {{0 32 w01 W 0 "Bit 63 to 32 Data signal of w01"}}} {0x34 b1_1 W 0x0 "Data signal of b1" {{0 32 b1 W 0 "Bit 31 to 0 Data signal of b1"}}} {0x38 b1_2 W 0x0 "Data signal of b1" {{0 32 b1 W 0 "Bit 63 to 32 Data signal of b1"}}} {0x40 w12_1 W 0x0 "Data signal of w12" {{0 32 w12 W 0 "Bit 31 to 0 Data signal of w12"}}} {0x44 w12_2 W 0x0 "Data signal of w12" {{0 32 w12 W 0 "Bit 63 to 32 Data signal of w12"}}} {0x4c b2_1 W 0x0 "Data signal of b2" {{0 32 b2 W 0 "Bit 31 to 0 Data signal of b2"}}} {0x50 b2_2 W 0x0 "Data signal of b2" {{0 32 b2 W 0 "Bit 63 to 32 Data signal of b2"}}} {0x58 w23_1 W 0x0 "Data signal of w23" {{0 32 w23 W 0 "Bit 31 to 0 Data signal of w23"}}} {0x5c w23_2 W 0x0 "Data signal of w23" {{0 32 w23 W 0 "Bit 63 to 32 Data signal of w23"}}} {0x64 b3_1 W 0x0 "Data signal of b3" {{0 32 b3 W 0 "Bit 31 to 0 Data signal of b3"}}} {0x68 b3_2 W 0x0 "Data signal of b3" {{0 32 b3 W 0 "Bit 63 to 32 Data signal of b3"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
## System Info
set user_parameters_list {clk_period 3.333330 machine 64 combinational 0 latency 20620964 II x}
...
set enable_xo_gen 1
set kernel_files {/home/h-ninomiya/SDAccel_Examples/vision/forward_aligned/src/krnl_forward.cl}
if {$enable_xo_gen} {
