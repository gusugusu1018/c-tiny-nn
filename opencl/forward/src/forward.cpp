...
/*
aligned_allocator float data[N_INPUT];
aligned_allocator float w01[N_INPUT*N_H1];
aligned_allocator float b1[N_H1];
aligned_allocator float w12[N_H1*N_H2];
aligned_allocator float b2[N_H2];
aligned_allocator float w23[N_H2*N_OUTPUT];
aligned_allocator float b3[N_OUTPUT];
*/
float data[N_INPUT];
