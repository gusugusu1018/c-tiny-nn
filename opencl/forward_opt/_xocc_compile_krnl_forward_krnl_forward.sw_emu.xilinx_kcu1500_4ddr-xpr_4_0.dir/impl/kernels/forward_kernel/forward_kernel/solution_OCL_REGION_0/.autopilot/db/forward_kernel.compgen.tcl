...
set id 7
set name forward_kernel_faddfsub_32ns_32ns_32_11_full_dsp
...
set id 8
set name forward_kernel_fmul_32ns_32ns_32_7_max_dsp
...
set id 9
set name forward_kernel_fdiv_32ns_32ns_32_30
...
set id 10
set name forward_kernel_sitofp_32ns_32_8
...
set id 11
set name forward_kernel_fcmp_32ns_32ns_1_3
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 14 \
			corename forward_kernel_control_axilite \
			name forward_kernel_control_s_axi \
			ports {$port_control} \
			op interface \
		} "
	} else {
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler forward_kernel_control_s_axi
}
...
eval "::AESL_LIB_XILADAPTER::m_axi_gen { \
    ...
    op interface \
    max_latency -1 \ 
    delay_budget 2.43333 \ 
    name {forward_kernel_gmem_m_axi} \
} "
} else {
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler forward_kernel_gmem_m_axi
}
