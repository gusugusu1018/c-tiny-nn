...
#ifndef __forward_kernel_fcmp_32ns_32ns_1_3__HH__
#define __forward_kernel_fcmp_32ns_32ns_1_3__HH__
#include "ACMP_fcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(forward_kernel_fcmp_32ns_32ns_1_3) {
    ...
    SC_CTOR(forward_kernel_fcmp_32ns_32ns_1_3):  ACMP_fcmp_U ("ACMP_fcmp_U") {
        ACMP_fcmp_U.clk(clk);
